<template>
  <nav class="navbar has-shadow is-fixed-top is-dark" role="navigation" aria-label="main navigation">
    <!-- <div class="container"> -->
      <div class="navbar-brand " style="margin-left: 1rem">
        <router-link tag="a" to="/" class="navbar-item">
          <span style="font-size: 28px">Narrately</span>
        </router-link>
      ...
      <div id="navbarBasicExample" class="navbar-menu ">
        ...
        <div class="navbar-end">
          ...
          <div v-if="$store.state.user" class="desktop-avatar">
            <router-link tag="a" to="/dashboard" >
              <figure class="image is-48x48" style="margin-top: 7px; margin-right: 3rem">
                <img :src="avatar" alt="Image" class="image img is-rounded is-48x48" style="margin-bottom: 5px">
              </figure>
            </router-link>
          </div>

          <div class="navbar-item has-dropdown is-hoverable is-hidden-desktop"  v-if="$store.state.user">
            <!-- <a class="navbar-link">
              More
            </a> -->
